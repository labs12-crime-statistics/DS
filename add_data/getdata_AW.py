...
query_locgroup = "locdestype.locgroup = ANY({locationgroupings})"
query_crmppo   = "crimetype.ppo = ANY({crimeppo})"
query_crmvio   = "crimetype.violence = ANY({crimevio})"
...
outputs   = ", ".join(["city.city", "city.state", "city.country", "incident.datetime", "incident.location", "crimetype.category", "locdesctype.key1 AS location_key1", "locdesctype.key2 AS location_key2", "locdesctype.key3 AS location_key3", "locdestype.locgroup", "crimetype.ppo", "crimetype.violence"])
if dotw != "":
